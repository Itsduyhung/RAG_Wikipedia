...
""")
    ...
    def chat(
        ...
        try:
            ...
            # Nếu model/credential sai (NOT_FOUND/permission/quota...), tránh làm API 500
            print(f"❌ LLM generate error: {e}")
            return {
                'answer': "Hiện tại hệ thống không thể gọi mô hình trả lời. Vui lòng kiểm tra LLM_MODEL_NAME và GEMINI_API_KEY.",
                'chunks': docs[:10],
                'metadata': {
